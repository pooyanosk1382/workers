...
label1 = tk.Label(root, image=image1, textvariable=line1, font=("Arial", 18), compound="left")
label1.pack(pady=10)
label2 = tk.Label(root, image=image2, textvariable=line2, font=("Arial", 18), compound="left")
label2.pack(pady=10)
label3 = tk.Label(root, image=image3, textvariable=line3, font=("Arial", 18), compound="left")
label3.pack(pady=10)
label4 = tk.Label(root, image=image4, textvariable=line4, font=("Arial", 18), compound="left")
label4.pack(pady=10)
label5 = tk.Label(root, image=image5, textvariable=line5, font=("Arial", 18), compound="left")
label5.pack(pady=10)
label6 = tk.Label(root, image=image6, textvariable=line6, font=("Arial", 18), compound="left")
label6.pack(pady=10)
label7 = tk.Label(root, image=image7, textvariable=line7, font=("Arial", 18), compound="left")
label7.pack(pady=10)
